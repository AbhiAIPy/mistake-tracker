...
with st.sidebar:
    ...
    if st.button("🚀 Upload & Save"):
        if uploaded_file and DRIVE_FOLDER_ID != "YOUR_FOLDER_ID_HERE":
            with st.spinner("Uploading to Google Drive..."):
                ...
                new_row = [
                    ...
                    image_link, # This is now a clickable URL
                    subject,
                    topic_tag.title(),
                    notes
                ]
            ...
            st.error("Missing Image or Folder ID!")
...
if data:
    ...
    # This part makes the link clickable in the Streamlit table
    st.dataframe(
        df, 
        column_config={
            "Image": st.column_config.LinkColumn("View Question")
        },
